...
class HFPosteditor:
    ...
    def postedit(self, source, mt):
        user_prompt = prompt=self.template.format(source=self.sourceLanguage,target=self.targetLanguage,source_sentence=source,machine_translation=mt)
